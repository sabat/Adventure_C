...
long ABB[186], ATAB[335], ATLOC[186], BLKLIN = TRUE, DFLAG,
		DLOC[7], FIXED[101], HOLDNG,
		KTAB[335], *LINES, LINK[201], LNLENG, LNPOSN,
		PARMS[26], PLACE[101], PTEXT[101], RTEXT[279],
		SETUP = 0, TABSIZ = 335;
char INLINE[101], MAP1[129], MAP2[129];

long ABBNUM, ACTSPK[36], AGAIN_WD1=-1, AGAIN_WD1X, AGAIN_WD2, AGAIN_WD2X, ALL,
		AMBER, ATTACK, AXE, BACK, BATTER, BEAR, BIRD, BLOOD, BONUS,
		 BOTTLE, CAGE, CAVE, CAVITY, CHAIN, CHASM, CHEST, CHLOC, CHLOC2,
		CLAM, CLOCK1, CLOCK2, CLOSED, CLOSNG, CLSHNT, CLSMAX = 12, CLSSES,
		COINS, COND[186], CONDS, CTEXT[13], CVAL[13], DALTLC, DETAIL,
		 DKILL, DOOR, DPRSSN, DRAGON, DSEEN[7], DTOTAL, DWARF, EASIER, EGGS,
		EMRALD, ENTER, ENTRNC, FIND, FISSUR, FIXD[101], FOOBAR, FOOD,
		GRATE, HINT, HINTED[21], HINTLC[21], HINTS[21][5], HNTMAX,
		HNTSIZ = 20, I, INVENT, IGO, IT=-1, IT_WD1=-1, IWEST, J, JADE, K, K2,
                KEY[186], KEYS, KK, KNFLOC, KNIFE, KQ, L, LAMP, LIMIT, LINSIZ = 12800,
                LINUSE, LL, LMWARN, LOC, LOCK, LOCSIZ = 185, LOCSND[186], LOOK,
                LTEXT[186], MAGZIN, MAXDIE, MAXTRS, MESH = 123456789,
		...
		RESER, ROD, ROD2, RTXSIZ = 279, RUBY, RUG, SAPPH, SAVED, SAY,
