...
/*  VERBOSE.  INTRANSITIVE ONLY.  GIVE LONG DESCRIPTIONS ONLY. */
 ...
 *  WITH JUNK VARIABLES TO BRING IT UP TO 7 VALUES. */
	...
	SAVWDS(OBJTXT[SIGN],CLSHNT,NOVICE,VERBOSE,K,K,K);
	SAVARR(ABB,LOCSIZ);
	SAVARR(ATLOC,LOCSIZ);
	SAVARR(DLOC,6);
	SAVARR(DSEEN,6);
