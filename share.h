...
extern long ABBNUM, ACTSPK[], AGAIN_WD1, AGAIN_WD1X, AGAIN_WD2,
   AGAIN_WD2X, ALL, AMBER, ATTACK, AXE, BACK, BATTER, BEAR, BIRD,
   BLOOD, BONUS,
   BOTTLE, CAGE, CAVE, CAVITY, CHAIN, CHASM, CHEST, CHLOC, CHLOC2,
   CLAM, CLOCK1, CLOCK2, CLOSED, CLOSNG, CLSHNT, CLSMAX, CLSSES,
   COINS, COND[], CONDS, CTEXT[], CVAL[], DALTLC, DETAIL,
   DKILL, DOOR, DPRSSN, DRAGON, DSEEN[], DTOTAL, DWARF, EASIER, EGGS,
   EMRALD, ENTER, ENTRNC, FIND, FISSUR, FIXD[], FOOBAR, FOOD,
   GRATE, HINT, HINTED[], HINTLC[], HINTS[][5], HNTMAX,
   HNTSIZ, I, INVENT, IGO, IT, IT_WD1, IWEST, J, JADE, K, K2,
   KEY[], KEYS, KK, KNFLOC, KNIFE, KQ, L, LAMP, LIMIT, LINSIZ,
   LINUSE, LL, LMWARN, LOC, LOCK, LOCSIZ, LOCSND[], LOOK, LTEXT[],
   ...
   TRVSIZ, TTEXT[], TURNS, URN, V1, V2, VASE, VEND, VERB, VERBOSE,
